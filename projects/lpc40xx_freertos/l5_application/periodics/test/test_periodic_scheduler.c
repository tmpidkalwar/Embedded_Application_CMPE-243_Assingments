...
void test_periodic_scheduler__initialize(void) {
  ...
  xTaskCreate_ExpectAndReturn(periodic_scheduler__100Hz_task, "100Hz", stack_size, NULL, PRIORITY_PERIODIC_100HZ, NULL, 0);
  xTaskCreate_ExpectAndReturn(periodic_scheduler__1000Hz_task, "1000Hz", stack_size, NULL, PRIORITY_PERIODIC_1000HZ, NULL, 0);

  xTaskCreate_ExpectAndReturn(periodic_scheduler__task_monitor, "xHz", stack_size, NULL, PRIORITY_PERIODIC_MONITOR, NULL, 0);
