...
static void init_data_sram_main(void);
static void init_data_sram_peripheral(void);
static void init_bss_sram_main(void);
static void init_bss_sram_peripheral(void);

void ram__init_data(void)
{
    init_data_sram_main();
    init_data_sram_peripheral();
}

void ram__init_bss(void)
{
    init_bss_sram_main();
    init_bss_sram_peripheral();
}
